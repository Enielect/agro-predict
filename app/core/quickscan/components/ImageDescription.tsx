      ...
      <div>
        ...
        <div>
          ...
          <p className="text-[#444444] py-3">
            Based on our analysis, we suggest you use a combination of organic
            and inorganic fertilizers to improve the soil fertility. This will
            help the plant grow better and reduce the effect of the nematodes.
          </p>
        </div>
      </div>
    </div>
